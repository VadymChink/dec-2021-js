...
for (let simpson of simpsons) {
    document.write( `${simpson.name}  ${simpson.surname} ${simpson.age} </br>${simpson.info} </br> <img src="${simpson.photo}" alt="${simpson.name}"> </br>`)
}
document.write('</div>');

document.write('</br> +<div class="wrapper">')
for (let simpson of simpsons) {
    document.write('<div>')
    document.write(`<h2>${simpson.name} ${simpson.surname} ${simpson.age}</h2> <p>${simpson.info}</p> </br> <img src="${simpson.photo}" alt="${simpson.name}">`)
    document.write('</div>')
}
document.write('</div>')
